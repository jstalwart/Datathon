...
global {
	...
	float step <- 1 #mn; /*How many time passes between stages in the model*/
	date starting_date <- date("2022-01-01-00-00-00"); /*Starting date */
	int nb_people <- 1; /*800.100 */ /*Number of locals initiated */
	int nb_turists <- 1; /*16.600 */ /*Number of turists initiated */
